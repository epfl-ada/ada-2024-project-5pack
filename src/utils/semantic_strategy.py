...
def semantic_increase_score(path: list[str], target_article: str) -> tuple[float, float]:
    ...
    The SIS quantifies how well semantic distances to the target article increase as players progress 
    along the path. It is a value between 0 and 1, where 1 indicates a perfect monotonic increase in
    semantic distance.
